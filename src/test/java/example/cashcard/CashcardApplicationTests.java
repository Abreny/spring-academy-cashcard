...
class CashcardApplicationTests {
	...
	void shouldCreateANewCard() {
		...
		URI locationOfNemCashCard = response.getHeaders().getLocation();
		ResponseEntity<String> getResponse = restTemplate.getForEntity(locationOfNemCashCard, String.class);
